...
coloredLine = toilet()
orb = cv2.ORB_create(nfeatures=1000, fastThreshold=40, nlevels=6, scaleFactor=1.2, patchSize=31, scoreType=cv2.ORB_FAST_SCORE) #(nfeatures=1800, fastThreshold=14, nlevels=12, scaleFactor=1.2, patchSize=31)
