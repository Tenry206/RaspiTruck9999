...
coloredLine = toilet()
orb = cv2.ORB_create(nfeatures=1000, fastThreshold=15, nlevels=12, scaleFactor=1.2, patchSize=31) #(nfeatures=1800, fastThreshold=14, nlevels=12, scaleFactor=1.2, patchSize=31)
